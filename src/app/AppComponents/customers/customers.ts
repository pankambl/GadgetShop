...
export class Customers {
  ...
  private loadCustomers(): void {
    const apiurl = 'https://gadget-shop-pk.netlify.app/api/Customer';
  ...
  deleteCustomerDetails(): void {
    const apiurl = "https://gadget-shop-pk.netlify.app/api/Customer/?CustomerId=" + this.customerIdToDelete;
