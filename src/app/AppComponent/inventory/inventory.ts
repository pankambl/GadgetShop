...
export class Inventory {
  ...
  private loadInventory(): void {
    const apiurl = 'https://gadget-s.netlify.app/api/Inventory';
  ...
  onSubmit() {
    const apiurl = 'hhttps://gadget-s.netlify.app/api/Inventory';
  ...
  deleteInvetory(): void {
    let apiurl = "https://gadget-s.netlify.app/api/Inventory/?productId=" + this.productIdToDelete;
